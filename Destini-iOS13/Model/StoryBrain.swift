...
struct StoryBrain {
    ...
    mutating func nextStory(choice: String) {
        ...
        let destination1 = stories[storyNumber].choice1Destination
        let destination2 = stories[storyNumber].choice2Destination
        
            if choice == choice1 {
                storyNumber = destination1
            } else if choice == choice2 {
                storyNumber = destination2
            }
    }
